...
def get_provider_stream_path(provider: str, subject_id: str, season: int, episode: int) -> Path:
    ...
    # v2 fixes MovieBox series caches that previously stored an unfiltered
    # default-quality collection page under every season/episode key.
    schema = "v2_" if provider == "moviebox" else ""
    # provider key check
